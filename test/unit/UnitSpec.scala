...
import controllers.SearchQueryForm
...
class UnitSpec extends PlaySpec {
  ...
  "WidgetForm" must {
    ...
    "apply successfully from request" in {
      ...
      val call = controllers.routes.SearchQueryController.createWidget()
      ...
      val boundForm = SearchQueryForm.form.bindFromRequest()
    ...
    "apply successfully from map" in {
      ...
      val boundForm = SearchQueryForm.form.bind(data)
      // You can then get the widget data out and test it.
      val widgetData = boundForm.value.get
    ...
    "show errors when applied unsuccessfully" in {
      ...
      val errorForm = SearchQueryForm.form.bind(data)
      // You can then get the widget data out and test it.
